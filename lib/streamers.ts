...
export function normalizeStreamer(id: string, data: Record<string, any>): Streamer {
  ...
  return {
    ...
    thumbnails: Array.isArray(data.thumbnails) ? data.thumbnails.slice(0, 5) : [],
    ...
    subscription_status: data.subscription_status === "canceled" ? "canceled" : data.subscription_status === "active" ? "active" : undefined,
