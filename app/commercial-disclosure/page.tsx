    ...
    <div className="app-shell">
      ...
      <main className="main grid-page">
        <section className="status-band legal-hero">
          <h1>特定商取引法に基づく表記</h1>
          <p>Vtuberマッチで提供する有料掲載プランおよび上位表示プランに関する表示です。</p>
        </section>
        ...
        <section className="legal-table">
          ...
          <DisclosureRow title="サービス提供時期">決済完了後、システム処理が完了次第、通常即時から3営業日以内に掲載を開始します。無料掲載は申し込み後に自動掲載されます。</DisclosureRow>
          ...
          <DisclosureRow title="動作環境">最新バージョンのChrome、Safari、Edgeなどの主要ブラウザ。スマートフォンではiOS Safari、Android Chromeの利用を推奨します。</DisclosureRow>
